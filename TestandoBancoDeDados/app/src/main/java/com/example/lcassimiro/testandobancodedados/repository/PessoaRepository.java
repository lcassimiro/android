package com.example.lcassimiro.testandobancodedados.repository;
...
import com.example.lcassimiro.testandobancodedados.uteis.DatabaseUtil;

import java.util.ArrayList;
import java.util.List;

/**
 * Created by lcassimiro on 13/03/2017.
 */
...
public class PessoaRepository {
    ...
    public void salvar(PessoaModel pessoaModel){
        ...
        databaseUtil.getConexaoDataBase().insert(databaseUtil.NOME_TABELA,null,contentValues);
    ...
    public void atualizar(PessoaModel pessoaModel){
        ...
        databaseUtil.getConexaoDataBase().update(databaseUtil.NOME_TABELA, contentValues, "id_pessoa = ?", new String[]{Integer.toString(pessoaModel.getCodigo())});
    }
    ...
    public Integer excluir(int codigo){
        ...
        return databaseUtil.getConexaoDataBase().delete(databaseUtil.NOME_TABELA,"id_pessoa = ?", new String[]{Integer.toString(codigo)});
    }
    ...
    public PessoaModel getPessoa(int codigo){
        ...
        Cursor cursor =  databaseUtil.getConexaoDataBase().rawQuery("SELECT * FROM "+databaseUtil.NOME_TABELA+" WHERE id_pessoa= "+ codigo,null);
    ...
    public List<PessoaModel> selecionarTodos(){
        ...
        stringBuilderQuery.append("  FROM  "+databaseUtil.NOME_TABELA);
